package com.ttn.springcloud.coupenservice.security.config;

import com.ttn.springcloud.coupenservice.security.UserDetailsServiceImpl;
...
//        http.formLogin();
        http.authorizeRequests()
                .mvcMatchers(HttpMethod.GET, "/couponapi/coupons/**", "/index",
                        "/showGetCoupon", "/couponDetails", "/getCoupon")
