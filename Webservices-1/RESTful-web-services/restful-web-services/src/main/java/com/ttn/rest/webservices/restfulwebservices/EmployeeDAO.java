...
import com.ttn.rest.webservices.restfulwebservices.exception.EmployeeNotFoundException;
...
public class EmployeeDAO {
    ...
    static {
        addEmployee(new EmployeeDTO(0, "Rakesh", 32));
        addEmployee(new EmployeeDTO(0, "Suresh", 30));
        addEmployee(new EmployeeDTO(0, "Alice", 23));
        addEmployee(new EmployeeDTO(0, "Bob", 22));
        addEmployee(new EmployeeDTO(0, "Peter", 42));
        addEmployee(new EmployeeDTO(0, "Samuel", 31));
    }
